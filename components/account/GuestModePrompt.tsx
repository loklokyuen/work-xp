...
export default function GuestModePrompt() {
    ...
    return (
        <View>
            <Text style={[styles.title, { color: colors.primary, ...fonts.titleLarge }]}>Welcome Guest!</Text>
            <Text style={[styles.body, { color: colors.tertiary, ...fonts.bodyMedium }]}>
                You are currently in guest mode. Please create an account or sign in to enjoy the full functionalities.
            </Text>
