...
export function EditableUserInfo({ businessInfo }) {
    ...
    return (
        <>
            <TextInput label="Company Bio" mode="outlined" multiline value={bio} onChangeText={(text) => setBio(text)} />
            <TextInput label="Industry" mode="outlined" value={industry} onChangeText={(text) => setIndustry(text)} />
            <TextInput
                label="Telephone"
                mode="outlined"
                value={phoneNum}
            ...
            />
            <TextInput label="Email" mode="outlined" value={email} onChangeText={(text) => setEmail(text)} keyboardType="email-address" />
            <TextInput label="Address" mode="outlined" multiline value={address} onChangeText={(text) => setAddress(text)} />
            <TextInput label="County" mode="outlined" value={county} onChangeText={(text) => setCounty(text)} />
            <Button
                mode="contained-tonal"
                onPress={() => {
