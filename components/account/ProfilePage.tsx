            ...
            <KeyboardAwareScrollView enableOnAndroid contentContainerStyle={styles.scrollViewContent}>
                ...
                {editMode ? (
                    businessInfo ? (
                        ...
                        studentInfo && <EditableStudentInfo studentInfo={studentInfo}  onUpdateInfo={handleUpdateInfo}  setChangesMade={setChangesMade} />
                    )
                ) : businessInfo ? (
                ...
                {!editMode && !guestMode && (
                    <View style={styles.buttonContainer}>
                        ...
                        <ConfirmActionModal open={openLogout} onClose={() => setOpenLogout(false)} title="Confirm logout?" onConfirmAction={handleLogout} />
                    </View>
                )}
