...
export function EditableStudentInfo({ studentInfo }) {
    ...
    return (
        <>
            <TextInput label="Personal Statement" mode="outlined" multiline value={bio} onChangeText={(text) => setBio(text)} />
            <TextInput label="Experience" mode="outlined" multiline value={experience} onChangeText={(text) => setExperience(text)} />
