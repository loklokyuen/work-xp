...
import { getBusinesses, getBusinessBySector, getBusinessByCounty } from "@/database/business";
...
const BusinessList: React.FC = () => {
    ...
    const filteredBusinesses = businesses.filter((biz) => biz.displayName.toLowerCase().includes(searchQuery.toLowerCase()));
                ...
                <View>
                    {loading ? (
                        ...
                        filteredBusinesses.map((biz, index) => (
                            <BusinessCards key={index} uid={biz.uid} displayName={biz.displayName} county={biz.county} photoUrl={biz.photoUrl} />
                        ))
                    ) : (
