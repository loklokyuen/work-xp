...
export default function AccountScreen() {
    ...
    return (
        ...
        >
            <Text style={[styles.title, { color: colors.primary, ...fonts.titleLarge }]}>Welcome to Work-XP!</Text>
            <Text style={[styles.body, { color: colors.tertiary, ...fonts.bodyMedium }]}>
                Find the work experience opportunity that's perfect for you, from the comfort of your phone! 📲
            </Text>
            <Text style={[styles.subTitle, { color: colors.quarternary, ...fonts.titleMedium }]}>New to the app?</Text>
            <Button
            ...
            <Text style={[styles.subTitle, { color: colors.quarternary, ...fonts.titleMedium }]}>Already have an account?</Text>
            <Button
                // mode="contained-tonal"
                // style={{ margin: 10 }}
                style={{
            ...
            <Text style={[styles.subTitle, { color: colors.quarternary, ...fonts.titleMedium }]}>Or just want to browse?</Text>
            <Button
                mode="outlined"
                // style={{ margin: 10 }}
                style={{
