...
import React, { Button, List } from "react-native-paper";
            ...
            {applications.map((application, index) => {
                return (
                    <List.Accordion
                        ...
                        style={application.isAccepted ? { backgroundColor: "green" } : { backgroundColor: "orange" }}
                        expanded={expanded}
                        onPress={() => setExpanded(!expanded)}
                    >
                        <View style={styles.accordionContent}>
                            <Text style={styles.text}>Applied to: {application?.businessName}</Text>
                            {application.isAccepted && <Text style={styles.text}>You have been accepted for this role</Text>}
                        </View>
                    </List.Accordion>
                );
            })}
