        ...
        <>
            <ScrollView contentContainerStyle={styles.scrollContainer}>
                ...
                <View style={styles.textContainer}>
                    <Text style={[styles.title, { color: colors.onSurface, fontFamily: "SpaceMono" }]}>{business?.displayName} </Text>
                    <Text style={[styles.industry, { color: colors.primary, fontFamily: "SpaceMono" }]}> {business?.sector} </Text>
                    <Text style={[styles.desc, { color: colors.onBackground, fontFamily: "SpaceMono" }]}> {business?.description}</Text>
                </View>
                {/* contact info */}
                <List.Section>
                    <List.Accordion
                        ...
                        right={() => <MaterialCommunityIcons name={expanded ? "chevron-up" : "chevron-down"} size={24} color={colors.onPrimary} />}
                    >
                        <View style={styles.accordionContent}>
                            <Text style={[styles.text, { color: colors.onSurface, fontFamily: "SpaceMono" }]}>Email: {business?.email}</Text>
                            <Text style={[styles.text, { color: colors.onSurface, fontFamily: "SpaceMono" }]}>
                                ...
                                onPress={async () => {
                                    ...
                                    if (await isFirstMessage(chatId)) {
                                        ...
                                        router.push({
                                            ...
                                            params: { chatRoomId: chatId, receiverAccountType: "Business" },
                                        });
                                    }
                                }}
                            >
